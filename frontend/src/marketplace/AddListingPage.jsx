...
import { X, Camera, ChevronDown, ChevronLeft, ChevronRight, Car, Home, Shirt, FileText, Smartphone, Gamepad2, Baby, Gift, Flower2, Palette, Sofa, Hammer, PawPrint, Trophy, Puzzle, MapPin } from 'lucide-react';
        ...
        <div className="w-[420px] bg-white border-r border-gray-200 overflow-y-auto shadow-sm scroll-w">
          <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                <div className="text-xs text-gray-500 mb-1 uppercase tracking-wide">Marketplace</div>
                <h1 className="text-2xl font-bold text-gray-900">Item for sale</h1>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3  pb-4 border-b border-gray-200">
              <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full flex items-center justify-center shadow-md">
                <img src={user?.image || '/defaultprf.png'} alt='user img' className='w-12 h-12 rounded-full'/>
              </div>
            ...
            <div className="">
              ...
              <div className="grid grid-cols-4 gap-2 mb-3">
                {images.map((image, index) => (
                  <div key={index} className="relative aspect-square bg-gray-100 rounded-xl overflow-hidden group shadow-sm hover:shadow-md transition-shadow">
                    <img
                      src={image.preview}
                      alt={`Upload ${index + 1}`}
                ...
                {images.length < maxImages && (
                  <label className="aspect-square bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-dashed border-gray-300 rounded-xl flex flex-col items-center justify-center cursor-pointer hover:border-blue-400 hover:bg-blue-50 transition-all group">
                    ...
                    <span className="text-xs text-gray-600 group-hover:text-[#1b5974] font-medium transition-colors">Add</span>
                    <input
                      type="file"
                      accept="image/*"
                      multiple
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-6">
                <h3 className="font-bold text-gray-900 text-lg m-0 p-0">Required</h3>
                <p className="text-sm text-gray-600 my-2 p-0">Be as descriptive as possible.</p>
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="flex-1 p-8 overflow-y-hidden">
              <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
                <div className="flex">
                  {/* Left - Image Section */}
                  <div className="w-[60%] bg-gray-50 relative">
                    {images.length > 0 ? (
                      <>
                  ...
                  <div className="flex-1 px-6 overflow-y-auto max-h-[600px]">
                    ...
                    <div className="border-t border-gray-200 ">
                    <hr className='bg-black/10 h-[0.5px]'/>
                      <div className="flex items-center justify-between">
                        <h4 className="font-semibold text-gray-900 my-1">Seller information</h4>
                      </div>
                      <div className="flex items-center gap-3">
                        <div className="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center">
                          <img src={user?.image || '/defaultprf.png'} alt="image" className="w-12 h-12 rounded-full"/>
                        </div>
                        <div>
                          <div className="font-semibold text-gray-900">{user?.name}</div>
                        </div>
