    ...
    <StyledWrapper>
      ...
      <form className="formm" onSubmit={register}>
        ...
        <div className="inputForm">
          ...
          <input type="password" className="input" name='password_confirmation' placeholder="Enter your Password" />
        </div>
        {errors.password&&<p style={{color:'red'}}>{errors.password}</p>}
        <button className="button-submit">Sign Up</button>
        <p className="p">Already have a account? <span className="span"  onClick={()=>navigate('/login')}>login</span></p>
      </form>
